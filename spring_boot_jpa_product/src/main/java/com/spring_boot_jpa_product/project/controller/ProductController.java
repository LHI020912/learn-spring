...
import com.spring_boot_jpa_product.project.service.IProductService;
...
public class ProductController {
	...
	public String insertProduct(ProductDTO vo) {
		service.insertProduct(vo); //호출해서 실행 오류가 없으면 insert 완료되었다는 의미
		//상품정보가 제대로 등록되었는 확인을 위한 재요청을 클라이언트에게 redirect 응답
