...
public class FileDownloadController {
	...
	public String fileDownloadView(Model model) {
		String downloadPath = "D:/springbootWorkspace/upload";
		File path = new File(downloadPath);
		String[] filelist = path.list(); // 파일 경로의 모든 파일의 경로와 이름정보를 리스트로 반환
	...
	public void fileDownload(@PathVariable String file, HttpServletResponse response) throws IOException {
		File f = new File("D:/springbootWorkspace/upload",file);
